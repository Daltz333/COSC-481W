...
public class StartPage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            Button settings_button = (Button) view.findViewById(R.id.settings_button);
            Button about_button = (Button) view.findViewById(R.id.about_button);
            start_button.setOnClickListener(args -> {
            ...
            about_button.setOnClickListener(args -> {
                NavHostFragment.findNavController(this).navigate(R.id.about);
            });
